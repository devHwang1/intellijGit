...
public class MembersController {
    ...
    @GetMapping("/modify")
    public String modify(Model model, @AuthenticationPrincipal MemberSecurityDTO memberSecurityDTO){
        model.addAttribute("memberFormDto", new MemberFormDto());
        return "member/memberModifyForm";
    }

    @PostMapping("/modify")
    public String modifyPW(String password, @AuthenticationPrincipal
